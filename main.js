...
const leftBtn = document.getElementById('left-botten');
const rightBtn = document.getElementById('right-botten');
const downBtn = document.getElementById('down-botten');
...
leftBtn.addEventListener(getConvertedEventType('mousedown'), () => {
  if (disableAction) return;
  left();
});

rightBtn.addEventListener(getConvertedEventType('mousedown'), () => {
  if (disableAction) return;
  right();
});
...
leftBtn.addEventListener(getConvertedEventType('mouseup'), () => {
  clearInterval(interval);
  interval = null;
});

rightBtn.addEventListener(getConvertedEventType('mouseup'), () => {
  clearInterval(interval);
  interval = null;
});
